...
function PAGE:Load(contentFrame, itemData)
	...
	textPanel.Paint = function(s , w , h)
		draw.SimpleText(BU3.Lang.Get("PS1_ITEM_EDITOR"), BU3.UI.Fonts["large_bold"], w/2, h/2, Color(255,255,255,20),1 ,1)
	end
	...
	local weaponClassEntry = BU3.UI.Elements.CreateTextEntry(BU3.Lang.Get("PS1_CLASS_NAME"), self.pages, false, false)
...
------------------------
	...
	local createCaseButton = BU3.UI.Elements.CreateStandardButton(BU3.Lang.Get("CREATEUPPS1ITEM"), self.pages, function()
