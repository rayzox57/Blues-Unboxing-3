...
function PAGE:Load(contentFrame, itemData)
	...
	textPanel.Paint = function(s , w , h)
		draw.SimpleText(BU3.Lang.Get("ENTEDITOR"), BU3.UI.Fonts["large_bold"], w/2, h/2, Color(255,255,255,20),1 ,1)
	end
	...
	local iconType = "Default Entity Icon"
...
------------------------------------------------------
	...
	local createCaseButton = BU3.UI.Elements.CreateStandardButton(BU3.Lang.Get("CUENT"), self.pages, function()
...
--Register the page
BU3.UI.RegisterPage("entityeditor", PAGE)