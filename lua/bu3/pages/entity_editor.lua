...
function PAGE:Load(contentFrame, itemData)
	...
	textPanel.Paint = function(s , w , h)
		draw.SimpleText("ENTITY EDITOR", BU3.UI.Fonts["large_bold"], w/2, h/2, Color(255,255,255,20),1 ,1)
	end
...
------------------------------------------------------
	...
	local createCaseButton = BU3.UI.Elements.CreateStandardButton("Create/Update Entity", self.pages, function()
