...
function PAGE:Load(contentFrame, itemData)
	...
	PAGE.ItemData.pointsAmount = ""
	PAGE.ItemData.type = "points1"
	...
	textPanel.Paint = function(s , w , h)
		draw.SimpleText(BU3.Lang.Get("PS1_EDITOR"), BU3.UI.Fonts["large_bold"], w/2, h/2, Color(255,255,255,20),1 ,1)
	end
...
--Register the page
BU3.UI.RegisterPage("points1editor", PAGE)