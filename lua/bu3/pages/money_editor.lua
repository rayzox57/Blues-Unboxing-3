...
function PAGE:Load(contentFrame, itemData)
	...
	textPanel.Paint = function(s , w , h)
		draw.SimpleText("MONEY EDITOR", BU3.UI.Fonts["large_bold"], w/2, h/2, Color(255,255,255,20),1 ,1)
	end
	...
	local weaponClassEntry = BU3.UI.Elements.CreateTextEntry("Money Amount", self.pages, false, false)
...
------------------------
	...
	local createCaseButton = BU3.UI.Elements.CreateStandardButton("Create/Update Money", self.pages, function()
