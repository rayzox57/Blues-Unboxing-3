...
function PAGE:Load(contentFrame, itemData)
	...
	textPanel.Paint = function(s , w , h)
		draw.SimpleText("POINTS EDITOR (PS2)", BU3.UI.Fonts["large_bold"], w/2, h/2, Color(255,255,255,20),1 ,1)
	end
	...
	local weaponClassEntry = BU3.UI.Elements.CreateTextEntry("Points Amount", self.pages, false, false)
...
------------------------
	...
	premiumText.Paint = function(s , w , h)
		draw.SimpleText("Use premium points?", BU3.UI.Fonts["small_bold"], 0, 0, Color(210,210,210,200),0 ,0)
	end	

	--Creates a pop up to add an item
	local createCaseButton = BU3.UI.Elements.CreateStandardButton("Create/Update Points", self.pages, function()
